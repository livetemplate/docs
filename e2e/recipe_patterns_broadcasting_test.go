...
//     /apps/ui-patterns/realtime/broadcasting
...
func TestRecipePatternsBroadcastingRenders(t *testing.T) {
	...
	if mountPath != "/apps/ui-patterns/realtime/broadcasting" {
		t.Errorf("mount path = %q, want /apps/ui-patterns/realtime/broadcasting", mountPath)
	}
	if !hasBroadcastH {
