...
<section class="alt"><div class="wrap two code-right">
  <div>
    ...
    <p class="lead">Slow work shouldn't mean a client-side state machine. <code>lvt-form:disable-with</code> disables the button and swaps its label while the action is in flight — that's the whole loading state, in one attribute. Click <b>Say hi</b> and watch it say <b>Saying hi…</b>:</p>
    <div class="live-card" style="margin-top:24px">
...
<pre><span class="tag">&lt;button</span> <span class="attr">name</span>=<span class="str">"greet"</span>
  <span class="attr">lvt-form:disable-with</span>=<span class="str">"Saying hi…"</span><span class="tag">&gt;</span>Say hi<span class="tag">&lt;/button&gt;</span></pre></div>
