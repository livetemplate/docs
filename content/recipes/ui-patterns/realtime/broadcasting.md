...
source_path: "examples/patterns/templates/realtime/broadcasting.tmpl"
---
...
```embed-lvt path="/apps/ui-patterns/realtime/broadcasting" upstream="http://localhost:9091" height="400px"
```
...
```html include="/examples/patterns/templates/realtime/broadcasting.tmpl" region="broadcasting"
```
...
[Broadcasting, deeper](/recipes/broadcasting). Use
